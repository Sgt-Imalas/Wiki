...
|材料:| 耗时: | 产物:|
|-|-|-|
| ![Cuprite](/assets/images/elements/Cuprite.png){.inline-icon} 铜矿 (400千克)<br>|40s| ![Copper](/assets/images/elements/Copper.png){.inline-icon} 铜 (400千克)<br>|
| ![Cobaltite](/assets/images/elements/Cobaltite.png){.inline-icon} 钴矿 (400千克)<br>|40s| ![Cobalt](/assets/images/elements/Cobalt.png){.inline-icon} 钴 (400千克)<br>|
| ![Wolframite](/assets/images/elements/Wolframite.png){.inline-icon} 黑钨矿 (400千克)<br>|40s| ![Tungsten](/assets/images/elements/Tungsten.png){.inline-icon} 钨 (400千克)<br>|
| ![ArgentiteOre](/assets/images/elements/ArgentiteOre.png){.inline-icon} 辉银矿 (400千克)<br>|40s| ![SolidSilver](/assets/images/elements/SolidSilver.png){.inline-icon} 银 (400千克)<br>|
| ![AluminumOre](/assets/images/elements/AluminumOre.png){.inline-icon} 铝矿 (400千克)<br>|40s| ![Aluminum](/assets/images/elements/Aluminum.png){.inline-icon} 铝 (400千克)<br>|
| ![GoldAmalgam](/assets/images/elements/GoldAmalgam.png){.inline-icon} 金汞齐 (400千克)<br>|40s| ![Gold](/assets/images/elements/Gold.png){.inline-icon} 金 (400千克)<br>|
| ![AurichalciteOre](/assets/images/elements/AurichalciteOre.png){.inline-icon} 锌矿 (400千克)<br>|40s| ![SolidZinc](/assets/images/elements/SolidZinc.png){.inline-icon} 锌 (400千克)<br>|
| ![NickelOre](/assets/images/elements/NickelOre.png){.inline-icon} 镍矿 (400千克)<br>|40s| ![Nickel](/assets/images/elements/Nickel.png){.inline-icon} 镍 (400千克)<br>|
| ![TempConductorSolid](/assets/images/elements/TempConductorSolid.png){.inline-icon} 导热质 (400千克)<br>|40s| ![Niobium](/assets/images/elements/Niobium.png){.inline-icon} 铌 (400千克)<br>|
| ![IronOre](/assets/images/elements/IronOre.png){.inline-icon} 铁矿 (400千克)<br>|40s| ![Iron](/assets/images/elements/Iron.png){.inline-icon} 铁 (400千克)<br>|
| ![Cinnabar](/assets/images/elements/Cinnabar.png){.inline-icon} 朱砂矿 (400千克)<br>|40s| ![Mercury](/assets/images/elements/Mercury.png){.inline-icon} 汞 (400千克)<br>|
| ![Electrum](/assets/images/elements/Electrum.png){.inline-icon} 银金矿 (400千克)<br>|40s| ![Gold](/assets/images/elements/Gold.png){.inline-icon} 金 (250千克)<br> ![Copper](/assets/images/elements/Copper.png){.inline-icon} 铜 (150千克)<br>|
| ![FoolsGold](/assets/images/elements/FoolsGold.png){.inline-icon} 黄铁矿 (400千克)<br>|40s| ![Iron](/assets/images/elements/Iron.png){.inline-icon} 铁 (300千克)<br> ![Sulfur](/assets/images/elements/Sulfur.png){.inline-icon} 硫 (100千克)<br>|
| ![Katairite](/assets/images/elements/Katairite.png){.inline-icon} 深渊晶石 (400千克)<br> ![RefinedCarbon](/assets/images/elements/RefinedCarbon.png){.inline-icon} 精炼碳 (100千克)<br> ![Lime](/assets/images/elements/Lime.png){.inline-icon} 石灰 (20千克)<br>|40s| ![Tungsten](/assets/images/elements/Tungsten.png){.inline-icon} 钨 (50千克)<br> ![Phosphorus](/assets/images/elements/Phosphorus.png){.inline-icon} 精炼磷 (100千克)<br> ![Sand](/assets/images/elements/Sand.png){.inline-icon} 沙子 (250千克)<br>|
| ![Iron](/assets/images/elements/Iron.png){.inline-icon} 铁 (280千克)<br> ![RefinedCarbon](/assets/images/elements/RefinedCarbon.png){.inline-icon} 精炼碳 (80千克)<br> ![Lime](/assets/images/elements/Lime.png){.inline-icon} 石灰 (40千克)<br>|40s| ![Steel](/assets/images/elements/Steel.png){.inline-icon} 钢 (400千克)<br>|
...
|**耗电:**| 800瓦 |&#8288 {: style="padding:0"}|
|**科技:**| 超热锻造|&#8288 {: style="padding:0"}| 
|**<font size="+1">建造材料:</font>**|<table><tr><td>钢 或 硬化合金</td><td>1000千克</td></tr></table> {colspan="2"} |&#8288 {: style="padding:0"}|

### 配方
|材料:| 耗时: | 随机产物:|
|-|-|-|
| ![SandStone](/assets/images/elements/SandStone.png){.inline-icon} 砂岩 (500千克)<br>|50s| ![CrushedRock](/assets/images/elements/CrushedRock.png){.inline-icon} 碎岩<br> ![Sand](/assets/images/elements/Sand.png){.inline-icon} 沙子<br> ![Cuprite](/assets/images/elements/Cuprite.png){.inline-icon} 铜矿<br> ![Electrum](/assets/images/elements/Electrum.png){.inline-icon} 银金矿<br> ![Fertilizer](/assets/images/elements/Fertilizer.png){.inline-icon} 肥料<br>|
| ![SedimentaryRock](/assets/images/elements/SedimentaryRock.png){.inline-icon} 沉积岩 (500千克)<br>|50s| ![CrushedRock](/assets/images/elements/CrushedRock.png){.inline-icon} 碎岩<br> ![Clay](/assets/images/elements/Clay.png){.inline-icon} 粘土<br> ![GoldAmalgam](/assets/images/elements/GoldAmalgam.png){.inline-icon} 金汞齐<br> ![FoolsGold](/assets/images/elements/FoolsGold.png){.inline-icon} 黄铁矿<br> ![Cobaltite](/assets/images/elements/Cobaltite.png){.inline-icon} 钴矿<br> ![Salt](/assets/images/elements/Salt.png){.inline-icon} 盐<br>|
| ![Shale](/assets/images/elements/Shale.png){.inline-icon} 页岩 (500千克)<br>|50s| ![CrushedRock](/assets/images/elements/CrushedRock.png){.inline-icon} 碎岩<br> ![Clay](/assets/images/elements/Clay.png){.inline-icon} 粘土<br> ![GoldAmalgam](/assets/images/elements/GoldAmalgam.png){.inline-icon} 金汞齐<br> ![FoolsGold](/assets/images/elements/FoolsGold.png){.inline-icon} 黄铁矿<br> ![Cobaltite](/assets/images/elements/Cobaltite.png){.inline-icon} 钴矿<br> ![Salt](/assets/images/elements/Salt.png){.inline-icon} 盐<br>|
| ![IgneousRock](/assets/images/elements/IgneousRock.png){.inline-icon} 火成岩 (500千克)<br>|50s| ![CrushedRock](/assets/images/elements/CrushedRock.png){.inline-icon} 碎岩<br> ![Sand](/assets/images/elements/Sand.png){.inline-icon} 沙子<br> ![FoolsGold](/assets/images/elements/FoolsGold.png){.inline-icon} 黄铁矿<br> ![Sulfur](/assets/images/elements/Sulfur.png){.inline-icon} 硫<br> ![IronOre](/assets/images/elements/IronOre.png){.inline-icon} 铁矿<br> ![Obsidian](/assets/images/elements/Obsidian.png){.inline-icon} 黑曜石<br>|
| ![Granite](/assets/images/elements/Granite.png){.inline-icon} 花岗岩 (500千克)<br>|50s| ![CrushedRock](/assets/images/elements/CrushedRock.png){.inline-icon} 碎岩<br> ![Sand](/assets/images/elements/Sand.png){.inline-icon} 沙子<br> ![AluminumOre](/assets/images/elements/AluminumOre.png){.inline-icon} 铝矿<br> ![IronOre](/assets/images/elements/IronOre.png){.inline-icon} 铁矿<br> ![Obsidian](/assets/images/elements/Obsidian.png){.inline-icon} 黑曜石<br>|
| ![MaficRock](/assets/images/elements/MaficRock.png){.inline-icon} 镁铁质岩 (500千克)<br>|50s| ![CrushedRock](/assets/images/elements/CrushedRock.png){.inline-icon} 碎岩<br> ![Sand](/assets/images/elements/Sand.png){.inline-icon} 沙子<br> ![AluminumOre](/assets/images/elements/AluminumOre.png){.inline-icon} 铝矿<br> ![Electrum](/assets/images/elements/Electrum.png){.inline-icon} 银金矿<br> ![Phosphorus](/assets/images/elements/Phosphorus.png){.inline-icon} 精炼磷<br>|
| ![Katairite](/assets/images/elements/Katairite.png){.inline-icon} 深渊晶石 (500千克)<br>|50s| ![Wolframite](/assets/images/elements/Wolframite.png){.inline-icon} 黑钨矿<br> ![Tungsten](/assets/images/elements/Tungsten.png){.inline-icon} 钨<br> ![Phosphorus](/assets/images/elements/Phosphorus.png){.inline-icon} 精炼磷<br> ![Obsidian](/assets/images/elements/Obsidian.png){.inline-icon} 黑曜石<br> ![Diamond](/assets/images/elements/Diamond.png){.inline-icon} 钻石<br> ![CrushedRock](/assets/images/elements/CrushedRock.png){.inline-icon} 碎岩<br> ![Sand](/assets/images/elements/Sand.png){.inline-icon} 沙子<br>|
...
|输入:|输出:|
|-|-|
| ![CrudeOil](/assets/images/elements/CrudeOil.png){.inline-icon} 原油 (5千克/秒)<br> ![CombustibleSolid](/assets/images/entities/CombustibleSolid.png){.inline-icon} 可燃固体 (100克/秒)<br>| ![Petroleum](/assets/images/elements/Petroleum.png){.inline-icon} 石油 (2500克/秒 于 98°C)<br> ![CarbonDioxide](/assets/images/elements/CarbonDioxide.png){.inline-icon} 二氧化碳 (50克/秒)<br> ![Methane](/assets/images/elements/Methane.png){.inline-icon} 天然气 (90克/秒 于 115°C)<br>|
...
| ![Fossil](/assets/images/elements/Fossil.png){.inline-icon} 化石 (100千克)<br>|40s| ![Lime](/assets/images/elements/Lime.png){.inline-icon} 石灰 (5千克)<br> ![CrushedRock](/assets/images/elements/CrushedRock.png){.inline-icon} 碎岩 (70千克)<br> ![Sand](/assets/images/elements/Sand.png){.inline-icon} 沙子 (25千克)<br>|
...
| ![Electrum](/assets/images/elements/Electrum.png){.inline-icon} 银金矿 (100千克)<br>|40s| ![Gold](/assets/images/elements/Gold.png){.inline-icon} 金 (25千克)<br> ![Copper](/assets/images/elements/Copper.png){.inline-icon} 铜 (15千克)<br> ![Sand](/assets/images/elements/Sand.png){.inline-icon} 沙子 (50千克)<br>|
...
|材料:| 耗时: | 产物:|
|-|-|-|
| ![Sand](/assets/images/elements/Sand.png){.inline-icon} 沙子 (150千克)<br> ![Salt](/assets/images/elements/Salt.png){.inline-icon} 盐 (10千克)<br>|10s| ![MoltenGlass](/assets/images/elements/MoltenGlass.png){.inline-icon} 熔融玻璃 (150千克)<br>|
| ![Cuprite](/assets/images/elements/Cuprite.png){.inline-icon} 铜矿 (500千克)<br>|10s| ![MoltenCopper](/assets/images/elements/MoltenCopper.png){.inline-icon} 熔融铜 (500千克)<br>|
| ![Cobaltite](/assets/images/elements/Cobaltite.png){.inline-icon} 钴矿 (500千克)<br>|10s| ![MoltenCobalt](/assets/images/elements/MoltenCobalt.png){.inline-icon} 熔融钴 (500千克)<br>|
| ![Wolframite](/assets/images/elements/Wolframite.png){.inline-icon} 黑钨矿 (500千克)<br>|10s| ![MoltenTungsten](/assets/images/elements/MoltenTungsten.png){.inline-icon} 熔融钨 (500千克)<br>|
| ![ArgentiteOre](/assets/images/elements/ArgentiteOre.png){.inline-icon} 辉银矿 (500千克)<br>|10s| ![MoltenSilver](/assets/images/elements/MoltenSilver.png){.inline-icon} 熔融银 (500千克)<br>|
| ![AluminumOre](/assets/images/elements/AluminumOre.png){.inline-icon} 铝矿 (500千克)<br>|10s| ![MoltenAluminum](/assets/images/elements/MoltenAluminum.png){.inline-icon} 熔融铝 (500千克)<br>|
| ![GoldAmalgam](/assets/images/elements/GoldAmalgam.png){.inline-icon} 金汞齐 (500千克)<br>|10s| ![MoltenGold](/assets/images/elements/MoltenGold.png){.inline-icon} 熔融金 (500千克)<br>|
| ![AurichalciteOre](/assets/images/elements/AurichalciteOre.png){.inline-icon} 锌矿 (500千克)<br>|10s| ![MoltenZinc](/assets/images/elements/MoltenZinc.png){.inline-icon} 熔融锌 (500千克)<br>|
| ![NickelOre](/assets/images/elements/NickelOre.png){.inline-icon} 镍矿 (500千克)<br>|10s| ![MoltenNickel](/assets/images/elements/MoltenNickel.png){.inline-icon} 熔融镍 (500千克)<br>|
| ![TempConductorSolid](/assets/images/elements/TempConductorSolid.png){.inline-icon} 导热质 (500千克)<br>|10s| ![MoltenNiobium](/assets/images/elements/MoltenNiobium.png){.inline-icon} 熔融铌 (500千克)<br>|
| ![IronOre](/assets/images/elements/IronOre.png){.inline-icon} 铁矿 (500千克)<br>|10s| ![MoltenIron](/assets/images/elements/MoltenIron.png){.inline-icon} 熔融铁 (500千克)<br>|
| ![Electrum](/assets/images/elements/Electrum.png){.inline-icon} 银金矿 (500千克)<br>|10s| ![MoltenGold](/assets/images/elements/MoltenGold.png){.inline-icon} 熔融金 (300千克)<br> ![MoltenCopper](/assets/images/elements/MoltenCopper.png){.inline-icon} 熔融铜 (200千克)<br>|
| ![FoolsGold](/assets/images/elements/FoolsGold.png){.inline-icon} 黄铁矿 (500千克)<br>|10s| ![MoltenIron](/assets/images/elements/MoltenIron.png){.inline-icon} 熔融铁 (400千克)<br> ![LiquidSulfur](/assets/images/elements/LiquidSulfur.png){.inline-icon} 液态硫 (100千克)<br>|
