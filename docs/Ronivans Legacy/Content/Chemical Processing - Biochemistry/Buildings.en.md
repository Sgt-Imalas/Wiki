...
| ![ColdWheatSeed](/assets/images/entities/ColdWheatSeed.png){.inline-icon} Sleet Wheat Grain (x20)<br> ![Water](/assets/images/elements/Water.png){.inline-icon} Water (30 kg)<br>|40s| ![Milk](/assets/images/elements/Milk.png){.inline-icon} Brackene (40 kg)<br>|
| ![SpiceNut](/assets/images/entities/SpiceNut.png){.inline-icon} Pincha Peppernut (6 kg)<br> ![Water](/assets/images/elements/Water.png){.inline-icon} Water (34 kg)<br>|40s| ![Milk](/assets/images/elements/Milk.png){.inline-icon} Brackene (40 kg)<br>|
| ![BeanPlantSeed](/assets/images/entities/BeanPlantSeed.png){.inline-icon} Nosh Bean (x4)<br> ![Water](/assets/images/elements/Water.png){.inline-icon} Water (36 kg)<br>|40s| ![Milk](/assets/images/elements/Milk.png){.inline-icon} Brackene (40 kg)<br>|
